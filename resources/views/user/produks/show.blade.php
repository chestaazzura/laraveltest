                    ...
                    @if ($produk->stock > 0)
                        <div class="space-y-4">
                            ...
                            <form action="{{ route('cart.add', $produk->id) }}" method="POST" class="space-y-4" id="addToCartForm">
                                ...
                                <div class="flex items-center space-x-4">
                                    <label for="quantity" class="text-gray-700">Jumlah:</label>
                                    <input type="number" name="qty" id="quantity" value="1" min="1" max="{{ $produk->stock }}" class="w-20 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                </div>

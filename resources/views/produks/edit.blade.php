                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('produks.update', $produk->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group text-center">
                                        ...
                                        <div class="mt-3">
                                            <img id="preview" src="{{ $produk->image_url ? asset('storage/uploads/produk/' . $produk->image_url) : asset('image/default-food.png') }}"
                                                 class="produk-img" alt="Gambar Produk">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-4 text-right">
                                ...
                                <a href="{{ route('produks.index') }}" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Batal</a>
                            </div>
                        </form>
                    </div>
                </div>

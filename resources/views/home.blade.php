    ...
    <div class="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-6">
      <div class="flex flex-col items-center space-y-2">
        ...
        <div class="flex space-x-4">
          <img src="img/playstore.png" alt="playstore" width="40" />
          <img src="img/appstore.png" alt="appstore" width="40" />
        </div>
      </div>
      ...
      <div class="flex flex-col items-center space-y-2">
        <span>We accept</span>
        <div class="flex space-x-4">
          <img src="img/mandiri.png" alt="mandiri" width="40" />
          <img src="img/bca.png" alt="bca" width="40" />
